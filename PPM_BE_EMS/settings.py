"""
Django settings for PPM_BE_EMS project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'cyYOCeq10CaKeTCnPyH8Uc4L7u-tw7EM8vY2hIxTBvw')
...
WSGI_APPLICATION = 'PPM_BE_EMS.wsgi.application'
